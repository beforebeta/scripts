...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CrawledLink.status_code'
        db.alter_column(u'main_crawledlink', 'status_code', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'CrawledLink.status_code'
        db.alter_column(u'main_crawledlink', 'status_code', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        u'main.backlink': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 9, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Crawl.crawl_type'
        db.add_column(u'main_crawl', 'crawl_type',
                      self.gf('django.db.models.fields.CharField')(default='bot', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Crawl.crawl_type'
        db.delete_column(u'main_crawl', 'crawl_type')
    ...
    models = {
        u'main.backlink': {
            ...
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.crawl': {
            ...
            'crawl_type': ('django.db.models.fields.CharField', [], {'default': "'bot'", 'max_length': '50'}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'main.crawledlink': {
            ...
            'crawl': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['main.Crawl']"}),
            'date_added': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'elapsed': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'history': ('picklefield.fields.PickledObjectField', [], {'default': '{}'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 13, 0, 0)', 'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'num_all_outbound_links': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'stats': ('picklefield.fields.PickledObjectField', [], {'default': '{}'}),
            'stats_json': ('django.db.models.fields.TextField', [], {'default': "''"}),
        ...
        u'main.url': {
            ...
            'stats_json': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'url': ('django.db.models.fields.TextField', [], {}),
            'url_255': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        }
    }

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrawledLink.contents_hash'
        db.add_column(u'main_crawledlink', 'contents_hash',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrawledLink.contents_hash'
        db.delete_column(u'main_crawledlink', 'contents_hash')

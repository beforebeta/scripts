...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrawledLink.stats'
        db.add_column(u'main_crawledlink', 'stats',
                      self.gf('picklefield.fields.PickledObjectField')(default={}),
                      keep_default=False)

        # Adding field 'CrawledLink.stats_json'
        db.add_column(u'main_crawledlink', 'stats_json',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrawledLink.stats'
        db.delete_column(u'main_crawledlink', 'stats')

        # Deleting field 'CrawledLink.stats_json'
        db.delete_column(u'main_crawledlink', 'stats_json')

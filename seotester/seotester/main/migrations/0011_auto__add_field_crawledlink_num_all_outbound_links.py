...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CrawledLink.num_all_outbound_links'
        db.add_column(u'main_crawledlink', 'num_all_outbound_links',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CrawledLink.num_all_outbound_links'
        db.delete_column(u'main_crawledlink', 'num_all_outbound_links')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URL'
        db.create_table(u'main_url', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.TextField')()),
            ('url_255', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('stats', self.gf('picklefield.fields.PickledObjectField')(default={})),
            ('stats_json', self.gf('django.db.models.fields.TextField')(default='')),
        ))
        db.send_create_signal(u'main', ['URL'])


    def backwards(self, orm):
        # Deleting model 'URL'
        db.delete_table(u'main_url')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestGroupingRun.overall_status'
        db.add_column(u'main_testgroupingrun', 'overall_status',
                      self.gf('django.db.models.fields.CharField')(default='Incomplete', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestGroupingRun.overall_status'
        db.delete_column(u'main_testgroupingrun', 'overall_status')

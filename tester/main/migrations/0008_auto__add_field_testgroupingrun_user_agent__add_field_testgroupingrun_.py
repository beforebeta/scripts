...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TestGroupingRun.user_agent'
        db.add_column(u'main_testgroupingrun', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TestGroupingRun.ip_address'
        db.add_column(u'main_testgroupingrun', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TestGroupingRun.user_agent'
        db.delete_column(u'main_testgroupingrun', 'user_agent')

        # Deleting field 'TestGroupingRun.ip_address'
        db.delete_column(u'main_testgroupingrun', 'ip_address')

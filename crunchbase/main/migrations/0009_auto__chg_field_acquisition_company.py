...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Acquisition.company'
        db.alter_column('main_acquisition', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Entity'], null=True))

    def backwards(self, orm):

        # Changing field 'Acquisition.company'
        db.alter_column('main_acquisition', 'company_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Entity']))
    ...
    models = {
        'main.acquisition': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Entity']", 'null': 'True', 'blank': 'True'}),
        ...
        'main.entity': {
            ...
            'permalink': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '255', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        'main.relationship': {
            ...
            'person': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Entity']", 'null': 'True', 'blank': 'True'}),

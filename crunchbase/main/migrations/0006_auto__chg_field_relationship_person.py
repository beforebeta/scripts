...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Relationship.person'
        db.alter_column('main_relationship', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Entity'], null=True))

    def backwards(self, orm):

        # Changing field 'Relationship.person'
        db.alter_column('main_relationship', 'person_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.Entity']))

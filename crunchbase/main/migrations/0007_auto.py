...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Entity', fields ['permalink']
        db.create_index('main_entity', ['permalink'])


    def backwards(self, orm):
        # Removing index on 'Entity', fields ['permalink']
        db.delete_index('main_entity', ['permalink'])

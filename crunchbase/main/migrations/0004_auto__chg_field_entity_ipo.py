...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entity.ipo'
        db.alter_column('main_entity', 'ipo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.IPO'], null=True))

    def backwards(self, orm):

        # Changing field 'Entity.ipo'
        db.alter_column('main_entity', 'ipo_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['main.IPO']))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Entity', fields ['permalink']
        db.create_unique('main_entity', ['permalink'])


    def backwards(self, orm):
        # Removing unique constraint on 'Entity', fields ['permalink']
        db.delete_unique('main_entity', ['permalink'])
